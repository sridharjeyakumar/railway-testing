...
export default function DebugPage() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        {managerData && managerData.manager && (
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <h4 className="text-md font-medium mt-4 mb-2">Users ({managerData.users?.count || 0})</h4>
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border">
                <thead>
                  <tr>
            ...
            <h4 className="text-md font-medium mt-4 mb-2">Staging Requests ({managerData.stagingRequests?.count || 0})</h4>
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border">
                <thead>
                  <tr>
            ...
            <h4 className="text-md font-medium mt-4 mb-2">Requests ({managerData.requests?.count || 0})</h4>
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border">
                <thead>
                  <tr>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h2 className="text-xl font-semibold mb-2">Users ({data.users?.count || 0})</h2>
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border">
              <thead>
                <tr>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2">Managers ({data.managers?.count || 0})</h2>
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border">
              <thead>
                <tr>
      ...
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2">Staging Requests ({data.stagingRequests?.count || 0})</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border">
            <thead>
              <tr>
      ...
      <div className="mt-6">
        <h2 className="text-xl font-semibold mb-2">Requests ({data.requests?.count || 0})</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border">
            <thead>
              <tr>
